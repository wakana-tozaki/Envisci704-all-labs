...
![Replace with your caption](images/your-screenshot.png){width=70%}

**Answer to task A1:** 
(images/envisci704-QuestionA1.png)
...
**Answer to task B1:**  (image/envisci704-QuestionB1.png)
...
**Answer to task C1:** (envisci704-QuestionC1.png)
